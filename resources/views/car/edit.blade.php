...
<div style="height: calc(100vh - 65px);overflow:hidden;">
    <form method="POST" enctype="multipart/form-data" action="{{ route('update_car', [ 'car'=>$car ]) }}" class="mx-auto max-w-3xl p-5 lg:mt-20 rounded bg-white">

        <h1 style="font-size: 2em;font-weight: bold;" class="text-center">Update a Car</h1>
